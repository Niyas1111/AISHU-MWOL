...
const array = ['Hi','Bot','alive','git','AishuMwol','Haa','help','Hii','Hai','mp3','Sed','Lub','Kgf','Eda','Ayshari','Video','Aa','song','cyber','Photo','Ayn','Andi','mp4','group','Myre','tts','Seen','Hlo','Suii','Axn4','Pm','Myr','Bgm','Da','Nop','owner','Vazha','sticker','Uyir','Chunk']
array.map( async (a) => {
